...
class ProductParser1:
    ...
    async def fetch_products(self, session, url, params):
        headers = {
            ...
            'Referer': 'https://www.wildberries.ru/catalog/zhenshchinam/odezhda/bryuki-i-shorty/shorty?page=1&sort=newly&xsubject=151',
    ...
    async def parse_category(self, base_url):
        self.db_manager.clear_table(Product1)
        ...
        async with aiohttp.ClientSession() as session:
            ...
            if all_products:
                self.db_manager.add_products(all_products, Product1)
            else:
